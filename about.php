			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>SGB resturent</span></h1>
						<h4>Little Story</h4>
				...
				<div class="col-md-12">
					<div class="inner-pt">
						<p> Making way for a hearty meal is SGB Restaurant in belagavi. This place is synonymous with delicious food that can satiate all food cravings. It is home to some of the most appreciated cuisines. So as to be able to cater to a large number of diners, it occupies a favourable location at belagavi, is where one can visit the venue. Courtesy to this strategic location, foodies in and around the neighborhood can walk in to this eating house conveniently without facing any hassles related to commuting to this part of the city. It is one of the most sought after Restaurants in South Bopal. This is a one of the renowned Restaurants in Ahmedabad.

 </p>
						<p>SGB restaurent at belagavi makes sure one has a great food experience by offering highly palatable food. The restaurant welcomes guests from 11:00-19:00 - 15:00-00:00 allowing diners to relish a scrumptious meal between the functional hours.The price range of the food at the restaurant ranges from 1. This listing is also listed in Restaurants, SGB Restaurants, Inexpensive  Restaurants (Below Rs 500), SGB delivery Restaurants.
 </p>
					</div>
				</div>
			</div>
