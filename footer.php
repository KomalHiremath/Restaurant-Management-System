	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">belagavi</p>
					<p class="lead"><a href="#">9988776655</a></p>
					<p><a href="#"> sgbrestaurent@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name"> &copy; 2020 <a href="#">Maher Kathiyawadi Restaurant</a> Developed By :  Avadh Tutor
					<a href=""></a><br>
